...
struct DiagonalLayoutMenu: View {
                ...
                VStack(alignment: .leading, spacing: 12) {
                    ...
                    VStack(alignment: .leading, spacing: 8) {
                        ...
                        HStack {
                            ...
                            Slider(value: $horizontalGap, in: -3.0...3.0, step: 0.1)
                    ...
                    VStack(alignment: .leading, spacing: 8) {
                        ...
                        HStack {
                            ...
                            Slider(value: $verticalGap, in: -3.0...3.0, step: 0.1)
