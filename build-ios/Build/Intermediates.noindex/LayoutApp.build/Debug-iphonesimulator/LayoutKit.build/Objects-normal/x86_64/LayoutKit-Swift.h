...
@class NSCoder;
SWIFT_CLASS("_TtC9LayoutKit8CardNode")
@interface CardNode : SKNode
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end

SWIFT_CLASS("_TtC9LayoutKit13CardTableNode")
@interface CardTableNode : SKNode
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end

/// A shape node that can be positioned by a layout system and reused from a pool
SWIFT_CLASS("_TtC9LayoutKit21LayoutableSKShapeNode")
@interface LayoutableSKShapeNode : SKShapeNode
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC9LayoutKit16SKCollectionNode")
@interface SKCollectionNode : SKNode
