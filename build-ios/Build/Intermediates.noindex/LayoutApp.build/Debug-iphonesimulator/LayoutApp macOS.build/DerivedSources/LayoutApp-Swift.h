...
// Generated by Apple Swift version 6.4 effective-5.10 (swiftlang-6.4.0.22.4 clang-2100.3.22.1)
#ifndef LAYOUTAPP_SWIFT_H
#define LAYOUTAPP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="LayoutApp",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class SKView;
@class NSCoder;
SWIFT_CLASS("_TtC9LayoutApp9BuraScene")
@interface BuraScene : SKScene
...
SWIFT_CLASS("_TtC9LayoutApp10DurakScene")
@interface DurakScene : SKScene
- (void)didMoveToView:(SKView * _Nonnull)view;
- (void)didChangeSize:(CGSize)oldSize;
- (nonnull instancetype)initWithSize:(CGSize)size OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC9LayoutApp19LayoutScenarioScene")
@interface LayoutScenarioScene : SKScene
- (void)didMoveToView:(SKView * _Nonnull)view;
- (void)didChangeSize:(CGSize)oldSize;
- (nonnull instancetype)initWithSize:(CGSize)size OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC9LayoutApp14SolitaireScene")
@interface SolitaireScene : SKScene
- (void)didMoveToView:(SKView * _Nonnull)view;
- (void)didChangeSize:(CGSize)oldSize;
...
/// classic Windows Solitaire waterfall. Idle otherwise (it only tracks <code>lastUpdate</code> for the next <code>dt</code>).
...
SWIFT_CLASS("_TtC9LayoutApp8WarScene")
@interface WarScene : SKScene
- (void)didMoveToView:(SKView * _Nonnull)view;
- (void)didChangeSize:(CGSize)oldSize;
- (nonnull instancetype)initWithSize:(CGSize)size OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
